...
export const PlaceLimitOrder: FC = () => {
  ...
  const handlePlaceOrder = useCallback(async () => {
    ...
    const referralTsg = network == 'devnet' ? process.env.NEXT_PUBLIC_REFERRER_TRG_DEVNET! : process.env.NEXT_PUBLIC_REFERRER_TRG_MAINNET!
    ...
    try {
        ...
        const orderIx = trader.getNewOrderIx(
            ...
            sizeFraction,
            false,
            referralTsg ? new PublicKey(referralTsg) : null,
            referralFee ? Number(referralFee) : null,
            null,
            null
        );
        // Get Prodcuts Array prices
